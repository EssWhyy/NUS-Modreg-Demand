...
const headCells = [
  ...
  },
  {
    ...
    numeric: true,
    disablePadding: false,
    label: 'Round Zero (demand/slots)',
  },
  {
    id: 'roundone',
    numeric: true,
    disablePadding: false,
    label: 'Round One (demand/slots)',
  },
  {
    id: 'roundtwo',
    numeric: true,
    disablePadding: false,
    label: 'Round Two (demand/slots)',
  },
];

//Below section should not be edited
...
export default function EnhancedTable({inputRows}) {
  ...
  const [orderBy, setOrderBy] = React.useState('modcode');
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.roundone}</TableCell>
                      <TableCell align="right">{row.roundtwo}</TableCell>
                    </TableRow>
                  );
                })}
